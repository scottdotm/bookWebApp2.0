...
public class BookController extends HttpServlet {
     ...
     @Inject
     private AbstractFacade<Books> bookService;
     @Inject
                    ...
                    case ADD_EDIT_DELETE_ACTION:
                         ...
                         if (subAction.equals(ADD_EDIT_ACTION)) {
                              ...
                              if (bookIds == null) {
                                   ...
                                   books = bookService.find(new Integer(bookId));
                              ...
                              for (String id : bookIds) {
                                   books = bookService.find(new Integer(id));
                                   bookService.remove(books);
                              }
...
//                        }
     ...
     // Avoid D-R-Y
     private void refreshBookList(HttpServletRequest request, AbstractFacade<Books> bookService) throws Exception {
